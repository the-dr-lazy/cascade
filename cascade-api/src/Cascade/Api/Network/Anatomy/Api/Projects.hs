...
type GetByIdResponse = '[Response.Unauthorized , Response.Forbidden , Response.NotFound , Response.Ok Project.Readable]

type UpdateByIdResponse = '[Response.Unauthorized , Response.Forbidden , Response.NotFound , Response.Ok Project.Readable]

type DeleteByIdResponse = '[Response.Unauthorized , Response.Forbidden , Response.NotFound , Response.Ok Project.Readable]
